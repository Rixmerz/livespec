...
> docs mutation tools are plugin-gated. Pin: `uvx livespec@0.30.1`.
>
...
are also **`livespec`** (`uvx livespec@0.30.1` / `pip install livespec`).
...
```bash
uvx livespec@0.30.1   # preferred — PyPI distribution name is `livespec`
...
> (`pip install livespec`, `uvx livespec@0.30.1`). The `livespec-mcp` command
