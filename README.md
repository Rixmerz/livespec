...
> docs mutation tools are plugin-gated. Pin: `uvx livespec@0.31.0`.
>
...
are also **`livespec`** (`uvx livespec@0.31.0` / `pip install livespec`).
...
```bash
uvx livespec@0.31.0   # preferred — PyPI distribution name is `livespec`
...
> (`pip install livespec`, `uvx livespec@0.31.0`). The `livespec-mcp` command
